...
<MnL:Bloqueo id="MLock" runat="server"/><MnA:MenuArriba id="MTop" runat="server"/>
...
<body  onload="generalJS('0','frmMeta|graficoCentro.aspx|idTemp;idTemp|idHome|GET|&j0=<%=Request.QueryString["j0"]%>&j1=<%=Request.QueryString["j1"]%>');" > <!--generalJS('0','frmMeta|___sqlAjax.aspx|idTemp;idTemp|idHome|GET|&typ=8')-->
...
</button><div class='modal-title' id='exampleModalLabel'></div></div>
  ...
  <tr>
   ...
   <img src="../___Images/principal.gif" width="33" height="29" border="0" />
    ...
    <%}%>
        ...
        <td width="100" align="right"><div class="dropdownM" id="drop1" style="z-index: 10">
     ...
     <a href="#"  onClick="javascript: generalJS('0','frmMeta|___sqlAjax2.aspx|idTemp;idTemp|idHome|GET|&typ=0'); ">Gestionar Reportes</a> <!-- abrirVentana('reporteGrafico.aspx?typ=19','hijo123','status=yes,width=1250,height=600'); -->
    ...
    <a href="#"  data-toggle='modal' data-target='#validador' data-whatever='@getbootstrap' onClick="javascript: exampleModalLabel.innerHTML='Descartar Disposici&oacute;n';  generalJS('0','frmMeta|___sqlAjax1.aspx|idTemp;idTemp|idValidador|GET|&typ=2');">Descartar Disposicion</a>       
      ...
      <td width="150"> <div class="dropdownM"  id="drop2" style="z-index: 10">
          ...
          <a href="#"  data-toggle='modal' data-target='#validador' data-whatever='@getbootstrap' onClick="javascript: exampleModalLabel.innerHTML='Cambio de Clave'; generalJS('0','frmMeta|___cambioClave.aspx|idTemp;idTemp|idValidador|GET|&typ=');">Cambio de Clave</a>
           ...
           <a href="#"  data-toggle='modal' data-target='#validador' data-whatever='@getbootstrap' onClick="javascript: exampleModalLabel.innerHTML='Registro de Correos'; generalJS('0','frmMeta|___registrarCorreo.aspx|idTemp;idTemp|idValidador|GET|&typ=R'); ">Registrar Correo</a>
            ...
            <% if (Session["sysTema"].ToString()=="Blue") { %> <img src="../___Images/check.gif" /> <%}%>            
            </a>
            ...
            <% if (Session["sysTema"].ToString()=="Black") { %> <img src="../___Images/check.gif" /> <%}%>
            </a>
          <!-- <%// if (tipoEdicion=="1"){ %>
...
<% if (tipoEdicion=="1"){ %>
       ...
       <td width="50">  <div class="dropdownM"  id="drop5" style="z-index: 10">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <br> 
      ...
      <div id='idMenuIzquierdo' style='width: 200; height:590px; overflow: auto; '><MnI:MenuIzquierdo id="MIzquierdo" runat="server"  /></div></td>
